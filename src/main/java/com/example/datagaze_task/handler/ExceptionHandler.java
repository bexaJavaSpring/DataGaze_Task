package com.example.datagaze_task.handler;

import com.example.datagaze_task.exception.AlreadyExistException;
...
import com.example.datagaze_task.util.ErrorUtil;
import com.example.datagaze_task.util.Translator;
...
public class ExceptionHandler {
    ...
    public ResponseEntity<?> handleValidatorException(final AlreadyExistException e) {
        log.error("AlreadyExistException on: {}", ErrorUtil.getStacktrace(e));
        return new ResponseEntity<>(Map.of("message", List.of(translator.toLocale(e.getMessage()))), new HttpHeaders(),
                HttpStatus.BAD_REQUEST);
    }
